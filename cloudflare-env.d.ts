/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 342ba81e5caab5bd562dd2fe4f173095)
// Runtime types generated with workerd@1.20260801.1 2026-08-11 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	NEXT_PUBLIC_STORAGE_BACKET: string;
	NEXT_PUBLIC_MESSAGING_SENDER_ID: string;
	NEXT_PUBLIC_APP_ID: string;
	NEXT_PUBLIC_MEASUREMENT_ID: string;
	WORKER_SELF_REFERENCE: Fetcher /* codewithshayy */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_API_KEY" | "NEXT_PUBLIC_AUTH_DOMAIN" | "NEXT_PUBLIC_PROJECT_ID" | "NEXT_PUBLIC_STORAGE_BACKET" | "NEXT_PUBLIC_MESSAGING_SENDER_ID" | "NEXT_PUBLIC_APP_ID" | "NEXT_PUBLIC_MEASUREMENT_ID">> {}
}
